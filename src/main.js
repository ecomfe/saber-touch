 ...
 * @file touch.js
 * 
 * @desc ported from [touchjs](https://github.com/brandnewera/touchjs) v0.2.13
...
define(function () {
    ...
    utils.getAngle180 = function(p1, p2) {
        var agl = Math.atan((p2.y - p1.y) * -1 / (p2.x - p1.x))
                * (180 / Math.PI);
